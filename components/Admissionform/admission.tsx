...
const AdmissionForm = () => {
  ...
  const handleChange = (
    ...
    let newValue = value;
    if (["mobileNumber", "fatherMobile", "motherMobile"].includes(name)) {
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          maxLength={10}
                          pattern="\d{10}"
                          className={`w-full pl-12 px-4 py-2 rounded-lg border ${errors.mobileNumber ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition`}
                        />
                      </div>
                      {errors.mobileNumber && (
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            maxLength={10}
                            pattern="\d{10}"
                            className={`w-full pl-12 px-4 py-2 rounded-lg border ${errors.fatherMobile ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition`}
                          />
                        </div>
                        {errors.fatherMobile && (
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            maxLength={10}
                            pattern="\d{10}"
                            className={`w-full pl-12 px-4 py-2 rounded-lg border ${errors.motherMobile ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition`}
                          />
                        </div>
                        {errors.motherMobile && (
                    ...
                    <label className="flex items-start space-x-3">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange({
                            ...e,
                            target: { ...e.target, name: "undertaking", value: e.target.checked ? "Yes" : "No" },
                          } as any)
                        }
