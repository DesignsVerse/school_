...
// SharePost Component (inline for simplicity, based on provided code)
const SharePost = ({ blog }: { blog: Blog }) => {
  return (
    <div className="mt-10 flex flex-wrap gap-4 md:items-center md:justify-between md:gap-0">
