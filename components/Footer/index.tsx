...
const Footer = () => {
  ...
  const quickLinks = [
    { name: "Best Services", href: "#" },
    { name: "Events", href: "#" },
    { name: "About Our Company", href: "#" },
    { name: "Business Contact", href: "#" },
    { name: "Make An Appointment", href: "#" }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering students through innovative education solutions that inspire creativity and foster academic excellence.
            </p>
            ...
            <form className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-full border border-gray-700 bg-gray-800 text-gray-400 px-6 py-3 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 transition"
                  required
                />
              </div>
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-full hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
              >
                Subscribe
